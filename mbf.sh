#!/bin/bash
#Creator Roniz
#apa liat liat? mau recode ya
#yang recode besok meninggal amin
#color(bold)
red='\e[1;31m'
green='\e[1;32m'
yellow='\e[1;33m'
...
#thread limit => jangan di ubah ubah jancok:v
limit=100

clear
echo "Subscribe Channel Kami Dahulu!!"
sleep 1
xdg-open https://www.youtube.com/channel/UC_Nh4GiuVut6skF4wks9nTg
sleep 2
...
echo "github: https://github.com/Mr-R0N1Z"
echo "======================================"
#dependencies
